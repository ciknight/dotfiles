...
" Get rid of vertical solit border
highlight VertSplit ctermfg=8 ctermbg=15 
set fillchars+=vert:\ 

"highlight StatusLineNC ctermfg=Yellow ctermbg=8
"augroup CursorLineOnlyInActiveWindow
  "autocmd!
  "autocmd VimEnter,WinEnter,BufWinEnter * highlight StatusLineNC ctermfg=Yellow
  "autocmd WinLeave * highlight StatusLineNC ctermfg=White
"augroup END
